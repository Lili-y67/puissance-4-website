...
try { db.exec(`ALTER TABLE players ADD COLUMN profile_wallpaper_desktop TEXT NOT NULL DEFAULT ''`); } catch(e) {}
try { db.exec(`ALTER TABLE players ADD COLUMN profile_wallpaper_mobile TEXT NOT NULL DEFAULT ''`); } catch(e) {}
...
const pQ = {
  ...
  leaderboard:  db.prepare(`SELECT * FROM players WHERE deleted = 0 AND is_guest = 0 AND is_bot = 0 ORDER BY elo DESC LIMIT 10`),
};
