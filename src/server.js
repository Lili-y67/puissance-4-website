...
app.patch('/api/players/:id/banner', (req, res) => {
  ...
  if (banner.length > 6 * 1024 * 1024) return res.status(400).json({ error: 'BanniAAaAa AaaAAaA AAAasAAazAAAaAAAasAA...AAAaAAasAAre trop lourde (max 4MB).' });
...
app.post('/api/players/:id/vip-boost', (req, res) => {
  ...
  res.json({ ok: true, expiresAt, message: 'AAaAa AaaAAaAAasAAAAaAAAasAAAAAaAAasAAAAaAAAasAA...AAAaAAasAA Boost VIP activAAaAa AaaAAaA AAAasAAazAAAaAAAasAA...AAAaAAasAA pour 1 heure !' });
});
