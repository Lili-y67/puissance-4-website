(function () {
  const ENDPOINT = 'http://127.0.0.1:6465/activity';
  ...
  function pageActivity(player) {
    ...
    if (path === '/game') {
      ...
      const variantNames = { classic:'Classique', rotate:'Plateau rotatif', anti:'Anti-P4', bomb:'Puissance Bombe', mission:'Mission personnelle', simultaneous:'Placement simultané', fog:'Brouillard de Guerre', conquest:'Conquête', naval:'Puissance 4 Navale', tetris:'p4-Tetris' };
